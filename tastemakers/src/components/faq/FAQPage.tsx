...
import { PRINCIPAL_H1_WRAP_LEADING_WEB } from '@/components/landing/principalHeadlineClassName'
    ...
    <main className="relative min-h-screen overflow-hidden bg-[#000d09] text-[#E8F5F0]">
      ...
      <div className="relative mx-[6vw] max-w-[1320px] py-9 md:py-12">
        <header className="flex items-center justify-between gap-6">
          <a href={`${import.meta.env.BASE_URL}#home`} aria-label="Back to Flent Tastemakers home">
