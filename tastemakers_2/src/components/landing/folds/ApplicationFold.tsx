...
import { Button } from '@tastemakers/components/ui/button'
import { PRINCIPAL_HEADLINE_CLASSNAME, PRINCIPAL_H1_WRAP_LEADING_WEB } from '@tastemakers/components/landing/principalHeadlineClassName'
import {
...
import { FloatingKey } from '@tastemakers/components/landing/shared/FloatingKey'
...
export function ApplicationFold() {
  ...
  async function handleSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    try {
      const res = await fetch('/api/tastemakers/submit-application', {
        method: 'POST',
